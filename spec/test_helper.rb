...
def load_test_data
  ...
  @item1 = Item.create!(name: "Colgate", description: "toothpaste", unit_price: 400, merchant: @merchant1, status: 1)
  @item2 = Item.create!(name: "Red Bell Pepper", description: "Vegetable", unit_price: 200, merchant: @merchant1, status: 1)
  @item3 = Item.create!(name: "Huskies", description: "dog food", unit_price: 200, merchant: @merchant1, status: 1)
  @item4 = Item.create!(name: "Gatorade", description: "drink", unit_price: 200, merchant: @merchant1, status: 1)
  @item5 = Item.create!(name: "Pretzels", description: "snack", unit_price: 400, merchant: @merchant1, status: 1)
  @item6 = Item.create!(name: "Chicken Breast", description: "meat", unit_price: 500, merchant: @merchant1, status: 1)
  @item7 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant1, status: 1)
  @item8 = Item.create!(name: "Colgate", description: "toothpaste", unit_price: 400, merchant: @merchant2, status: 1)
  @item9 = Item.create!(name: "Red Bell Pepper", description: "Vegetable", unit_price: 200, merchant: @merchant2, status: 1)
  @item10 = Item.create!(name: "Huskies", description: "dog food", unit_price: 2000, merchant: @merchant2, status: 1)
  @item11 = Item.create!(name: "Gatorade", description: "drink", unit_price: 200, merchant: @merchant2, status: 1)
  @item12 = Item.create!(name: "Pretzels", description: "snack", unit_price: 400, merchant: @merchant2, status: 1)
  @item13 = Item.create!(name: "Chicken Breast", description: "meat", unit_price: 500, merchant: @merchant2, status: 1)
  @item14 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant2, status: 1)
  @item15 = Item.create!(name: "Colgate", description: "toothpaste", unit_price: 400, merchant: @merchant3, status: 1)
  @item16 = Item.create!(name: "Red Bell Pepper", description: "Vegetable", unit_price: 200, merchant: @merchant3, status: 1)
  @item17 = Item.create!(name: "Huskies", description: "dog food", unit_price: 2000, merchant: @merchant3, status: 1)
  @item18 = Item.create!(name: "Gatorade", description: "drink", unit_price: 200, merchant: @merchant3, status: 1)
  @item19 = Item.create!(name: "Pretzels", description: "snack", unit_price: 400, merchant: @merchant3, status: 1)
  @item20 = Item.create!(name: "Chicken Breast", description: "meat", unit_price: 500, merchant: @merchant3, status: 1)
  @item21 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant3, status: 1)
  @item22 = Item.create!(name: "Colgate", description: "toothpaste", unit_price: 400, merchant: @merchant4, status: 1)
  @item23 = Item.create!(name: "Red Bell Pepper", description: "Vegetable", unit_price: 200, merchant: @merchant4, status: 1)
  @item24 = Item.create!(name: "Huskies", description: "dog food", unit_price: 2000, merchant: @merchant4, status: 1)
  @item25 = Item.create!(name: "Gatorade", description: "drink", unit_price: 200, merchant: @merchant4, status: 1)
  @item26 = Item.create!(name: "Pretzels", description: "snack", unit_price: 400, merchant: @merchant4, status: 1)
  @item27 = Item.create!(name: "Chicken Breast", description: "meat", unit_price: 500, merchant: @merchant4, status: 1)
  @item28 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant4, status: 1)
  @item29 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant5, status: 1)
  @item30 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant5, status: 1)
  @item31 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant5, status: 1)
  @item32 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant5, status: 1)
  @item33 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant5, status: 1)
  @item34 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant5, status: 1)
  @item35 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant5, status: 1)
  @item36 = Item.create!(name: "Mug", description: "a thing to drink from", unit_price: 200, merchant: @merchant1, status: 1)
  @item37 = Item.create!(name: "Book", description: "a thing to read from", unit_price: 500, merchant: @merchant2, status: 1)
  @item38 = Item.create!(name: "Card", description: "a thing to write on", unit_price: 200, merchant: @merchant3, status: 1)
  @item39 = Item.create!(name: "Bag", description: "a thing to hold stuff in", unit_price: 200, merchant: @merchant4, status: 1)
  @item40 = Item.create!(name: "Keychain", description: "a thing to hold ur keys", unit_price: 100, merchant: @merchant5, status: 1)
  @item41 = Item.create!(name: "Lamp", description: "a thing to light up ur room", unit_price: 800, merchant: @merchant6, status: 1)
  @item42 = Item.create!(name: "Mouse", description: "a thing for ur cat to chase", unit_price: 800, merchant: @merchant7, status: 1)
  @item44 = Item.create!(name: "Clip", description: "a thing for clip stuff together", unit_price: 200, merchant: @merchant8, status: 1)
  @item45 = Item.create!(name: "Shelf", description: "a thing to set ur stuff on", unit_price: 1000, merchant: @merchant9, status: 1)
  @item46 = Item.create!(name: "Hook", description: "a thing hang ur stuff on", unit_price: 800, merchant: @merchant10, status: 1)
...
def load_best_test_data
  ...
  @invoice_1 = Invoice.create!(status: "completed", customer: @customer_1, updated_at: "2023-01-11 14:54:09 UTC")
  @invoice_2 = Invoice.create!(status: "completed", customer: @customer_1, updated_at: "2023-02-23 13:54:09 UTC")
  @invoice_3 = Invoice.create!(status: "completed", customer: @customer_1, updated_at: "2023-03-15 11:54:09 UTC")
  @invoice_4 = Invoice.create!(status: "completed", customer: @customer_1, updated_at: "2023-04-17 17:54:09 UTC")
  @invoice_5 = Invoice.create!(status: "completed", customer: @customer_1, updated_at: "2023-05-25 16:54:09 UTC")
  @invoice_6 = Invoice.create!(status: "completed", customer: @customer_1, updated_at: "2023-06-21 15:54:09 UTC")
  @invoice_7 = Invoice.create!(status: "completed", customer: @customer_1, updated_at: "2023-07-01 14:54:09 UTC")
  @invoice_8 = Invoice.create!(status: "cancelled", customer: @customer_1, updated_at: "2023-08-19 12:54:09 UTC")
  @invoice_9 = Invoice.create!(status: "completed", customer: @customer_1, updated_at: "2023-09-17 11:54:09 UTC")
  @invoice_10 = Invoice.create!(status: "completed", customer: @customer_1, updated_at: "2023-10-27 14:54:09 UTC")
  @invoice_11 = Invoice.create!(status: "completed", customer: @customer_1, updated_at: "2023-11-07 14:54:09 UTC")
  @invoice_12 = Invoice.create!(status: "completed", customer: @customer_1, updated_at: "2023-12-02 14:54:09 UTC")
  @invoice_13 = Invoice.create!(status: "completed", customer: @customer_1, updated_at: "2023-03-18 14:54:09 UTC")
  @invoice_14 = Invoice.create!(status: "completed", customer: @customer_1, updated_at: "2023-07-09 14:54:09 UTC")

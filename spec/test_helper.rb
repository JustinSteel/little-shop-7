...
def load_test_data
  ...
  @item1 = Item.create!(name: "Colgate", description: "toothpaste", unit_price: 400, merchant: @merchant1, status: 0)
  @item2 = Item.create!(name: "Red Bell Pepper", description: "Vegetable", unit_price: 200, merchant: @merchant1, status: 0)
  @item3 = Item.create!(name: "Huskies", description: "dog food", unit_price: 200, merchant: @merchant1, status: 0)
  @item4 = Item.create!(name: "Gatorade", description: "drink", unit_price: 200, merchant: @merchant1, status: 0)
  @item5 = Item.create!(name: "Pretzels", description: "snack", unit_price: 400, merchant: @merchant1, status: 0)
  @item6 = Item.create!(name: "Chicken Breast", description: "meat", unit_price: 500, merchant: @merchant1, status: 0)
  @item7 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant1, status: 0)
  @item8 = Item.create!(name: "Colgate", description: "toothpaste", unit_price: 400, merchant: @merchant2, status: 0)
  @item9 = Item.create!(name: "Red Bell Pepper", description: "Vegetable", unit_price: 200, merchant: @merchant2, status: 0)
  @item10 = Item.create!(name: "Huskies", description: "dog food", unit_price: 2000, merchant: @merchant2, status: 0)
  @item11 = Item.create!(name: "Gatorade", description: "drink", unit_price: 200, merchant: @merchant2, status: 0)
  @item12 = Item.create!(name: "Pretzels", description: "snack", unit_price: 400, merchant: @merchant2, status: 0)
  @item13 = Item.create!(name: "Chicken Breast", description: "meat", unit_price: 500, merchant: @merchant2, status: 0)
  @item14 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant2, status: 0)
  @item15 = Item.create!(name: "Colgate", description: "toothpaste", unit_price: 400, merchant: @merchant3, status: 0)
  @item16 = Item.create!(name: "Red Bell Pepper", description: "Vegetable", unit_price: 200, merchant: @merchant3, status: 0)
  @item17 = Item.create!(name: "Huskies", description: "dog food", unit_price: 2000, merchant: @merchant3, status: 0)
  @item18 = Item.create!(name: "Gatorade", description: "drink", unit_price: 200, merchant: @merchant3, status: 0)
  @item19 = Item.create!(name: "Pretzels", description: "snack", unit_price: 400, merchant: @merchant3, status: 0)
  @item20 = Item.create!(name: "Chicken Breast", description: "meat", unit_price: 500, merchant: @merchant3, status: 0)
  @item21 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant3, status: 0)
  @item22 = Item.create!(name: "Colgate", description: "toothpaste", unit_price: 400, merchant: @merchant4, status: 0)
  @item23 = Item.create!(name: "Red Bell Pepper", description: "Vegetable", unit_price: 200, merchant: @merchant4, status: 0)
  @item24 = Item.create!(name: "Huskies", description: "dog food", unit_price: 2000, merchant: @merchant4, status: 0)
  @item25 = Item.create!(name: "Gatorade", description: "drink", unit_price: 200, merchant: @merchant4, status: 0)
  @item26 = Item.create!(name: "Pretzels", description: "snack", unit_price: 400, merchant: @merchant4, status: 0)
  @item27 = Item.create!(name: "Chicken Breast", description: "meat", unit_price: 500, merchant: @merchant4, status: 0)
  @item28 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant4, status: 0)
  @item29 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant5, status: 0)
  @item30 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant5, status: 0)
  @item31 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant5, status: 0)
  @item32 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant5, status: 0)
  @item33 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant5, status: 0)
  @item34 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant5, status: 0)
  @item35 = Item.create!(name: "Coors", description: "alcohol", unit_price: 200, merchant: @merchant5, status: 0)
  @item36 = Item.create!(name: "Mug", description: "a thing to drink from", unit_price: 200, merchant: @merchant1, status: 0)
  @item37 = Item.create!(name: "Book", description: "a thing to read from", unit_price: 500, merchant: @merchant2, status: 0)
  @item38 = Item.create!(name: "Card", description: "a thing to write on", unit_price: 200, merchant: @merchant3, status: 0)
  @item39 = Item.create!(name: "Bag", description: "a thing to hold stuff in", unit_price: 200, merchant: @merchant4, status: 0)
  @item40 = Item.create!(name: "Keychain", description: "a thing to hold ur keys", unit_price: 100, merchant: @merchant5, status: 0)
  @item41 = Item.create!(name: "Lamp", description: "a thing to light up ur room", unit_price: 800, merchant: @merchant6, status: 0)
  @item42 = Item.create!(name: "Mouse", description: "a thing for ur cat to chase", unit_price: 800, merchant: @merchant7, status: 0)
  @item44 = Item.create!(name: "Clip", description: "a thing for clip stuff together", unit_price: 200, merchant: @merchant8, status: 0)
  @item45 = Item.create!(name: "Shelf", description: "a thing to set ur stuff on", unit_price: 1000, merchant: @merchant9, status: 0)
  @item46 = Item.create!(name: "Hook", description: "a thing hang ur stuff on", unit_price: 800, merchant: @merchant10, status: 0)
